...
var getPopular = function(){
	//console.log('called');
return $http.get('http://api.themoviedb.org/3/discover/movie?api_key='+apiKey+'&include_video=true')
.then(function(res){
	return res.data;
});	
};
...
var getMovie = function(id){
	return $http.get('http://api.themoviedb.org/3/movie/'+id+'?api_key='+apiKey+'&append_to_response=videos')
.then(function(res){
	return res.data;
});
};
